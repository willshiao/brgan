...
#     print('Running orca')
    ...
    Path('./orca_tmp').mkdir(exist_ok=True)
    tmp_fname = 'orca_tmp/orca_tmp_{}.txt'.format(uuid.uuid4().hex[:6])
    try:
        ...
        output = sp.check_output(['./graphrnn/orca/orca', 'node', '4', tmp_fname, 'std'])
